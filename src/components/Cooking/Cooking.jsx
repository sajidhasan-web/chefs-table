             ...
             <table className="table-auto fira">
                    ...
                    <tbody className="w-full">
                      <tr className="bg-[#28282813] text-[#878787] w-full">
                          <td className="px-6 xl:px-12">1</td>
                          <td  className="px-6 xl:px-12">The Sliding</td>
                          <td  className="px-6 xl:px-12">Malcolm Lockyer</td>
                          <td  className="px-6 xl:px-12">1961</td>
                      </tr>   
